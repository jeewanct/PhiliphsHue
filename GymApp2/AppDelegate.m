...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UIStoryboard *storu=[UIStoryboard storyboardWithName:@"Main" bundle:nil];
    TutorialViewController *controlLightsViewController=[storu instantiateViewControllerWithIdentifier:@"TutorialViewController"];
